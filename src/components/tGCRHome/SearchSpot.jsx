...
const SearchSpot = ({ currentUser, lang, getStartedDict }) => {
	...
	return (
		<>
			<div className="features-area ptb-100 bg-fef8ef">
				<div className="container">
					...
					<div className={styles["shape2"]}>
						<Image src="/images/shape2.png" width={100} height={120} alt="image" />
					</div>
				</div>
			</div>
		</>
